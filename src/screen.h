...
//     oledWriteString(Screen::oled, 0, 0, 1, Data::strbuffer, FONT_6x8, 0, 0);

//     //Draw Player DMG
    
//     sprintf(Data::strbuffer, Data::xGetString(STRING::battlescreen_dm), Screen::player->Dmg);
//     oledWriteString(Screen::oled, 0, 0, 2, Data::strbuffer, FONT_6x8, 0, 0);

//     //Draw Player DEF
    
//     sprintf(Data::strbuffer, Data::xGetString(STRING::battlescreen_df), Screen::player->Def);
//     oledWriteString(Screen::oled, 0, 0, 3, Data::strbuffer, FONT_6x8, 0, 0);
...
//     oledWriteString(Screen::oled, 0, 98, 1, Data::strbuffer, FONT_6x8, 0, 0);

//     //Draw Enemy DMG

    
//     sprintf(Data::strbuffer, Data::xGetString(STRING::battlescreen_dm), Enemy.Dmg);
//     oledWriteString(Screen::oled, 0, 98, 2, Data::strbuffer, FONT_6x8, 0, 0);

//     //Draw Enemy DEF

    
//     sprintf(Data::strbuffer, Data::xGetString(STRING::battlescreen_dm), Enemy.Def);
//     oledWriteString(Screen::oled, 0, 98, 3, Data::strbuffer, FONT_6x8, 0, 0);
...
//     oledWriteString(Screen::oled, 0, 4, 1, Data::xGetString(STRING::enemygeneration_nextup), FONT_6x8, 0, 0);
...
//     oledWriteString(Screen::oled, 0, 64 - 3 * 6, 2, Data::xGetString(STRING::enemydead), FONT_6x8, 0, 0);
...
//     oledWriteString(Screen::oled, 0, 4, 1, Data::strbuffer, FONT_6x8, 0, 0);

//     sprintf(Data::strbuffer, Data::xGetString(STRING::info_2), enemy->Name, enemy->Hp, enemy->MaxHp);
//     oledWriteString(Screen::oled, 0, 4, 2, Data::strbuffer, FONT_6x8, 0, 0);
...
//     if (has_s)
//     {
//       oledWriteString(Screen::oled, 0, (strlen(player->Name)) * 6, 0, Data::xGetString(STRING::home_welcome_s), FONT_6x8, 0, 0);
//     }
//     else
//     { 
//       oledWriteString(Screen::oled, 0, (strlen(player->Name)) * 6, 0, Data::xGetString(STRING::home_welcome_nos), FONT_6x8, 0, 0);
//     }

//     oledWriteString(Screen::oled, 0, (strlen(player->Name) + 2 + (!has_s)) * 6, 0, Data::xGetString(STRING::home_welcome), FONT_6x8, 0, 0);
...
//       if (text_rows[0] != STRING::blank_space) oledWriteString(Screen::oled, 0, 3, 0, Data::xGetString(text_rows[0]),0,0,0);
//       if (text_rows[0] != STRING::blank_space) oledWriteString(Screen::oled, 0, 3, 1, Data::xGetString(text_rows[1]),0,0,0);
//       if (text_rows[0] != STRING::blank_space) oledWriteString(Screen::oled, 0, 3, 2, Data::xGetString(text_rows[2]),0,0,0);
//       if (text_rows[0] != STRING::blank_space) oledWriteString(Screen::oled, 0, 3, 3, Data::xGetString(text_rows[3]),0,0,0);

//       oledDrawLine(Screen::oled, 2,0,0,15,0);
//       oledDrawLine(Screen::oled, 0,15,2,31,0);
//       oledDrawLine(Screen::oled, 124,0,127,15,0);
//       oledDrawLine(Screen::oled, 127,15,124,31,0);
//       oledDumpBuffer(Screen::oled, NULL);
//   }
